...
--
-- Host: localhost
-- Generation Time: Jun 16, 2022 at 12:30 PM
...
CREATE TABLE `Orders` (
  ...
  `ItemOrdersitemID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `Orders` (`orderID`, `customerEmail`, `staffID`, `dateTime`, `deliveryAddress`, `deliveryDate`, `totalPrice`, `ItemOrdersitemID`) VALUES
(1, 'mary@gmail.com', 's0001', '2022-03-24 13:12:13', NULL, NULL, 2910, NULL),
(2, 'tom@gmail.com', 's0001', '2022-04-10 14:10:20', 'Flat 8, Chates Farm Court, John Street, Hong Kong', '2022-04-15', 11440, NULL),
(3, 'mary@gmail.com', 's003', '2022-04-12 14:10:20', NULL, NULL, 500, NULL);
